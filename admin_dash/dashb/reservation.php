...
if (isset($_GET['room_id'])){
    ...
    $get_room_price = $get_room['price'] - $get_room['price']*20/100;         /// 20% discounted price
}
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h4 style="font-weight: bold">Price: <span id="price"><?php echo $get_room_price; ?></span> /- <small style="color:green"><i><strong>20% Discounted Price</strong></i></small></h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price">0</span> /-</h4>
                                </div>
                                <div> || <small style="color:green"><i><strong>Single:&#8209;&nbsp;1000</strong></i></small> || 
                                <small style="color:green"><i><strong>Double:&#8209;&nbsp;1500</strong></i></small>  || 
                                <small style="color:green"><i><strong>Triple:&#8209;&nbsp;2000</strong></i></small>  || 
                                <small style="color:green"><i><strong>Family:&#8209;&nbsp;3000</strong></i></small>  || 
                                <small style="color:green"><i><strong>King Sized:&#8209;&nbsp;5500</strong></i></small>  || 
                                <small style="color:green"><i><strong>Master Suite:&#8209;&nbsp;6500</strong></i></small>  || 
                                <small style="color:green"><i><strong>Mini Suite:&#8209;&nbsp;3600</strong></i></small>  || 
                                <small style="color:green"><i><strong>Connecting Rooms:&#8209;&nbsp;8000</strong></i></small>  || 
                                <small style="color:green"><i><strong>Presidential Suite:&#8209;&nbsp;21000</strong></i></small>  || 
                                <small style="color:green"><i><strong>Murphy Room:&#8209;&nbsp;6900</strong></i></small>  || 
                                </div>
                            </div>
                        </div>
                    <?php } else{?>
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <h4 style="font-weight: bold">Total Days : <span id="staying_day">0</span> Days</h4>
                                    <h4 style="font-weight: bold">Price: <span id="price">0</span> /- <small style="color:green"><i><strong>20% Discounted Price</strong></i></small></h4>
                                    <h4 style="font-weight: bold">Total Amount : <span id="total_price">0</span> /-</h4>
                                </div>
                                <div> || <small style="color:green"><i><strong>Single:&#8209;&nbsp;1000</strong></i></small> || 
                                <small style="color:green"><i><strong>Double:&#8209;&nbsp;1500</strong></i></small>  || 
